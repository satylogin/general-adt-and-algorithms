/* *
 * Code - single-ended circular queue, Author - Satyarth Agrahari
 * --------------------------------------------------------------
 * The following is a circular queue implementation using array
 * in c language. It is single ended queue adt.
 */
...
void enqueue(queue *q, int data)
{
	if (is_full(q)) {
		...
		// we increase the value of rear in a way that it never
		// exceeds max size but instead rotates
